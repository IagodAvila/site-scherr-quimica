...
<link rel="stylesheet" href="/assets/app.css?v=20260903-botoes" />
<link rel="stylesheet" href="/style.css?v=20260903-botoes" />
</head>
    ...
    <div class="mt-8 grid gap-10 lg:grid-cols-[minmax(0,520px)_minmax(0,1fr)] lg:items-center lg:gap-14">
      <div>
        ...
        <div class="entra entra-3 mt-8 flex flex-wrap gap-3">
          ...
          <a href="https://wa.me/5531992247394" target="_blank" rel="noopener noreferrer" class="acao acao-varre varre-branco border border-sobre-verde-dim/50 px-5 py-3 font-semibold text-sobre-verde">Falar com um técnico</a>
        </div>
...
<section id="orcamento" class="bg-verde-fundo">
  <div class="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
    ...
    <div class="mt-8 flex flex-wrap gap-3">
      <a href="/#contato" class="acao acao-varre varre-verde bg-white px-5 py-3 font-semibold text-verde-fundo">Solicitar avaliação técnica</a>
      <a href="tel:+5531992247394" class="acao acao-varre varre-branco border border-sobre-verde-dim/50 px-5 py-3 font-semibold text-sobre-verde">+55 (31) 99224-7394</a>
    </div>
  </div>
</section>
</main>
